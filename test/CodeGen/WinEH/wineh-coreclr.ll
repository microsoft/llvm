...
; CHECK-NEXT: .long [[L_fault]]@IMGREL-[[L_begin]]@IMGREL
;                   ^ offset from L_begin to start of 3rd funclet
; CHECK-NEXT: .long [[L_finally]]@IMGREL-[[L_begin]]@IMGREL
;                   ^ offset from L_begin to start of 4th funclet
; CHECK-NEXT: .long [[L_end]]@IMGREL-[[L_begin]]@IMGREL
...
; CHECK-NEXT: .long ([[L_before_f2]]@IMGREL+1)-[[L_begin]]@IMGREL
;                   ^ offset of start of clause
; CHECK-NEXT: .long ([[L_after_f2]]@IMGREL+1)-[[L_begin]]@IMGREL
...
; CHECK-NEXT: .long ([[L_before_f1]]@IMGREL+1)-[[L_begin]]@IMGREL
;                   ^ offset of start of clause
; CHECK-NEXT: .long ([[L_after_f2]]@IMGREL+1)-[[L_begin]]@IMGREL
;                   ^ offset of end of clause
; CHECK-NEXT: .long [[L_finally]]@IMGREL-[[L_begin]]@IMGREL
...
; CHECK-NEXT: .long ([[L_before_f3]]@IMGREL+1)-[[L_begin]]@IMGREL
;                   ^ offset of start of clause
; CHECK-NEXT: .long ([[L_after_f3]]@IMGREL+1)-[[L_begin]]@IMGREL
;                   ^ offset of end of clause
; CHECK-NEXT: .long [[L_finally]]@IMGREL-[[L_begin]]@IMGREL
;                   ^ offset of start of handler
; CHECK-NEXT: .long [[L_end]]@IMGREL-[[L_begin]]@IMGREL
...
; CHECK-NEXT: .long ([[L_before_f5]]@IMGREL+1)-[[L_begin]]@IMGREL
;                   ^ offset of start of clause
; CHECK-NEXT: .long ([[L_after_f5]]@IMGREL+1)-[[L_begin]]@IMGREL
;                   ^ offset of end of clause
; CHECK-NEXT: .long [[L_fault]]@IMGREL-[[L_begin]]@IMGREL
;                   ^ offset of start of handler
; CHECK-NEXT: .long [[L_finally]]@IMGREL-[[L_begin]]@IMGREL
...
; CHECK-NEXT: .long 10
;                   ^ flags (2 => finally handler | 8 => duplicate)
; CHECK-NEXT: .long ([[L_before_f4]]@IMGREL+1)-[[L_begin]]@IMGREL
;                   ^ offset of start of clause
; CHECK-NEXT: .long ([[L_after_f5]]@IMGREL+1)-[[L_begin]]@IMGREL
;                   ^ offset of end of clause
; CHECK-NEXT: .long [[L_finally]]@IMGREL-[[L_begin]]@IMGREL
...
; CHECK-NEXT: .long 10
;                   ^ flags (2 => finally handler | 8 => duplicate)
; CHECK-NEXT: .long ([[L_before_f6]]@IMGREL+1)-[[L_begin]]@IMGREL
;                   ^ offset of start of clause
; CHECK-NEXT: .long ([[L_after_f6]]@IMGREL+1)-[[L_begin]]@IMGREL
;                   ^ offset of end of clause
; CHECK-NEXT: .long [[L_finally]]@IMGREL-[[L_begin]]@IMGREL
;                   ^ offset of start of handler
; CHECK-NEXT: .long [[L_end]]@IMGREL-[[L_begin]]@IMGREL
