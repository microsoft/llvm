...
; RUN: llc < %s -mtriple=x86_64-apple-darwin -mcpu=corei7 -stackmap-version=2 | FileCheck --check-prefix=V2CHECK %s
;
...
; V2CHECK-NEXT:	.long	8
; V2CHECK-NEXT:	.short	9
; V2CHECK-NEXT:	.short	6
; V2CHECK-NEXT:	.short	0
; V2CHECK-NEXT:	.short	1
; V2CHECK-NEXT:	.align	3
; V2CHECK-NEXT:	.quad	_osrinline
; V2CHECK-NEXT:	.long	L{{.*}}-_osrinline
...
; V2CHECK-NEXT:	.short	1
; V2CHECK-NEXT:	.align	3
; V2CHECK-NEXT:	.quad	_osrcold
; V2CHECK-NEXT:	.long	L{{.*}}-_osrcold
; V2CHECK-NEXT:	.long	8
; V2CHECK-NEXT:	.short	1
; V2CHECK-NEXT:	.short	6
...
; V2CHECK-NEXT:	.short	1
; V2CHECK-NEXT:	.align	3
; V2CHECK-NEXT:	.quad	_propertyRead
; V2CHECK-NEXT:	.long	L{{.*}}-_propertyRead
; V2CHECK-NEXT:	.long	8
; V2CHECK-NEXT:	.short	9
; V2CHECK-NEXT:	.short	6
...
; V2CHECK-NEXT:	.short	1
; V2CHECK-NEXT:	.align	3
; V2CHECK-NEXT:	.quad	_propertyWrite
; V2CHECK-NEXT:	.long	L{{.*}}-_propertyWrite
; V2CHECK-NEXT:	.long	8
; V2CHECK-NEXT:	.short	9
; V2CHECK-NEXT:	.short	6
...
; V2CHECK-NEXT:	.short	1
; V2CHECK-NEXT:	.align	3
; V2CHECK-NEXT:	.quad	_jsVoidCall
; V2CHECK-NEXT:	.long	L{{.*}}-_jsVoidCall
; V2CHECK-NEXT:	.long	8
; V2CHECK-NEXT:	.short	9
; V2CHECK-NEXT:	.short	6
; V2CHECK-NEXT:	.short	5
; V2CHECK-NEXT:	.short	1
; V2CHECK-NEXT:	.align	3
; V2CHECK-NEXT:	.quad	_jsIntCall
; V2CHECK-NEXT:	.long	L{{.*}}-_jsIntCall
; V2CHECK-NEXT:	.long	8
; V2CHECK-NEXT:	.short	9
; V2CHECK-NEXT:	.short	6
; V2CHECK-NEXT:	.short	6
; V2CHECK-NEXT:	.short	1
; V2CHECK-NEXT:	.align	3
; V2CHECK-NEXT:	.quad	_spilledValue
; V2CHECK-NEXT:	.long	L{{.*}}-_spilledValue
; V2CHECK-NEXT:	.long	56
; V2CHECK-NEXT:	.short	9
; V2CHECK-NEXT:	.short	6
; V2CHECK-NEXT:	.short	7
; V2CHECK-NEXT:	.short	1
; V2CHECK-NEXT:	.align	3
; V2CHECK-NEXT:	.quad	_spilledStackMapValue
; V2CHECK-NEXT:	.long	L{{.*}}-_spilledStackMapValue
; V2CHECK-NEXT:	.long	56
; V2CHECK-NEXT:	.short	1
; V2CHECK-NEXT:	.short	6
; V2CHECK-NEXT:	.short	8
; V2CHECK-NEXT:	.short	1
; V2CHECK-NEXT:	.align	3
; V2CHECK-NEXT:	.quad	_spillSubReg
; V2CHECK-NEXT:	.long	L{{.*}}-_spillSubReg
; V2CHECK-NEXT:	.long	56
; V2CHECK-NEXT:	.short	1
; V2CHECK-NEXT:	.short	6
; V2CHECK-NEXT:	.short	9
; V2CHECK-NEXT:	.short	1
; V2CHECK-NEXT:	.align	3
; V2CHECK-NEXT:	.quad	_subRegOffset
; V2CHECK-NEXT:	.long	L{{.*}}-_subRegOffset
; V2CHECK-NEXT:	.long	56
; V2CHECK-NEXT:	.short	1
; V2CHECK-NEXT:	.short	6
; V2CHECK-NEXT:	.short	10
; V2CHECK-NEXT:	.short	1
; V2CHECK-NEXT:	.align	3
...
; V2CHECK-NEXT:	.short	4
; V2CHECK-NEXT:	.align	3
; V2CHECK-NEXT:	.quad	_clobberScratch
; V2CHECK-NEXT:	.long	L{{.*}}-_clobberScratch
; V2CHECK-NEXT:	.long	56
; V2CHECK-NEXT:	.short	1
; V2CHECK-NEXT:	.short	6
; V2CHECK-NEXT:	.short	18
; V2CHECK-NEXT:	.short	1
; V2CHECK-NEXT:	.align	3
; V2CHECK-NEXT:	.quad	_needsStackRealignment
; V2CHECK-NEXT:	.long	L{{.*}}-_needsStackRealignment
; V2CHECK-NEXT:	.long	4294967295
; V2CHECK-NEXT:	.short	5
; V2CHECK-NEXT:	.short	6
; V2CHECK-NEXT:	.short	19
; V2CHECK-NEXT:	.short	1
; V2CHECK-NEXT:	.align	3
...
; V2CHECK-NEXT:	.short	2
; V2CHECK-NEXT:	.align	3
; V2CHECK-NEXT:	.quad	11
; V2CHECK-NEXT:	.long	L{{.*}}-_spilledValue
; V2CHECK-NEXT:	.byte	0
; V2CHECK-NEXT:	.byte	1
; V2CHECK-NEXT:	.short	24
; V2CHECK-NEXT:	.short	17
; V2CHECK-NEXT:	.short	7
; V2CHECK-NEXT:	.short	1
; V2CHECK-NEXT:	.align	3
; V2CHECK-NEXT:	.quad	12
; V2CHECK-NEXT:	.long	L{{.*}}-_spilledStackMapValue
; V2CHECK-NEXT:	.byte	0
; V2CHECK-NEXT:	.byte	0
; V2CHECK-NEXT:	.short	41
; V2CHECK-NEXT:	.short	17
; V2CHECK-NEXT:	.short	8
; V2CHECK-NEXT:	.short	0
; V2CHECK-NEXT:	.align	3
; V2CHECK-NEXT:	.quad	13
; V2CHECK-NEXT:	.long	L{{.*}}-_spillSubReg
; V2CHECK-NEXT:	.byte	0
; V2CHECK-NEXT:	.byte	0
; V2CHECK-NEXT:	.short	58
; V2CHECK-NEXT:	.short	1
; V2CHECK-NEXT:	.short	8
; V2CHECK-NEXT:	.short	0
; V2CHECK-NEXT:	.align	3
; V2CHECK-NEXT:	.quad	14
; V2CHECK-NEXT:	.long	L{{.*}}-_subRegOffset
; V2CHECK-NEXT:	.byte	0
; V2CHECK-NEXT:	.byte	0
; V2CHECK-NEXT:	.short	59
; V2CHECK-NEXT:	.short	2
; V2CHECK-NEXT:	.short	8
; V2CHECK-NEXT:	.short	0
; V2CHECK-NEXT:	.align	3
...
; V2CHECK-NEXT:	.byte	0
; V2CHECK-NEXT:	.byte	0
; V2CHECK-NEXT:	.short	62
; V2CHECK-NEXT:	.short	1
; V2CHECK-NEXT:	.short	8
; V2CHECK-NEXT:	.short	0
; V2CHECK-NEXT:	.align	3
; V2CHECK-NEXT:	.quad	17
; V2CHECK-NEXT:	.long	L{{.*}}-_directFrameIdx
; V2CHECK-NEXT:	.byte	0
; V2CHECK-NEXT:	.byte	1
; V2CHECK-NEXT:	.short	63
; V2CHECK-NEXT:	.short	2
; V2CHECK-NEXT:	.short	8
; V2CHECK-NEXT:	.short	1
; V2CHECK-NEXT:	.align	3
...
; V2CHECK-NEXT:	.byte	1
; V2CHECK-NEXT:	.byte	8
; V2CHECK-NEXT:	.short	15
; V2CHECK-NEXT:	.long	0
; V2CHECK-NEXT:	.align	2
; V2CHECK-NEXT:	.byte	3
; V2CHECK-NEXT:	.byte	8
; V2CHECK-NEXT:	.short	6
; V2CHECK-NEXT:	.long	72
; V2CHECK-NEXT:	.align	2
; V2CHECK-NEXT:	.byte	3
; V2CHECK-NEXT:	.byte	8
; V2CHECK-NEXT:	.short	6
; V2CHECK-NEXT:	.long	80
; V2CHECK-NEXT:	.align	2
; V2CHECK-NEXT:	.byte	3
; V2CHECK-NEXT:	.byte	8
; V2CHECK-NEXT:	.short	6
; V2CHECK-NEXT:	.long	88
; V2CHECK-NEXT:	.align	2
; V2CHECK-NEXT:	.byte	3
; V2CHECK-NEXT:	.byte	8
; V2CHECK-NEXT:	.short	6
; V2CHECK-NEXT:	.long	96
; V2CHECK-NEXT:	.align	2
; V2CHECK-NEXT:	.byte	3
; V2CHECK-NEXT:	.byte	8
; V2CHECK-NEXT:	.short	6
; V2CHECK-NEXT:	.long	104
; V2CHECK-NEXT:	.align	2
; V2CHECK-NEXT:	.byte	3
; V2CHECK-NEXT:	.byte	8
; V2CHECK-NEXT:	.short	6
; V2CHECK-NEXT:	.long	112
; V2CHECK-NEXT:	.align	2
; V2CHECK-NEXT:	.byte	3
; V2CHECK-NEXT:	.byte	8
; V2CHECK-NEXT:	.short	6
; V2CHECK-NEXT:	.long	120
; V2CHECK-NEXT:	.align	2
; V2CHECK-NEXT:	.byte	3
; V2CHECK-NEXT:	.byte	8
; V2CHECK-NEXT:	.short	6
; V2CHECK-NEXT:	.long	128
; V2CHECK-NEXT:	.align	2
; V2CHECK-NEXT:	.byte	3
; V2CHECK-NEXT:	.byte	8
; V2CHECK-NEXT:	.short	6
; V2CHECK-NEXT:	.long	136
; V2CHECK-NEXT:	.align	2
; V2CHECK-NEXT:	.byte	1
; V2CHECK-NEXT:	.byte	8
; V2CHECK-NEXT:	.short	0
...
; V2CHECK-NEXT:	.byte	4
; V2CHECK-NEXT:	.short	6
; V2CHECK-NEXT:	.long	-44
; V2CHECK-NEXT:	.align	2

; LiveOut Array
; V2CHECK-NEXT:	.align	1
; V2CHECK-NEXT:L{{.*}}:
; V2CHECK-NEXT:	.short	7
; V2CHECK-NEXT:	.byte	0
; V2CHECK-NEXT:	.byte	8
